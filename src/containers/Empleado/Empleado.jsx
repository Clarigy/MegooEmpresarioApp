...
export class Empleado extends Component {
    ...
    componentDidMount = () => {
        ...
        let docRef = db.collection('Tiendas').doc(this.state.uidEmpleado);
    ...
    Activar = async (e) => {
        ...
        let newTienda = db.collection(collection).doc(this.state.uid);
        batch.update(newTienda, {
            estado: 'Pendiente'
        });

        let deleteTienda = db.collection('Tiendas').doc(this.state.uidEmpleado);
        batch.update(deleteTienda, {
        ...
        let collectionRef = db.collection('Tiendas').doc(this.state.uidEmpleado);
        collectionRef.collection('notificaciones').add({
            mensaje: 'Esta Tienda quiere que vuelvas a ser parte de su equipo',
            tienda: this.state.Tienda,
            estado: 'Activa'
        });
                ...
                <>
                    <div className='container-fluid'>
                        <div className='mx-0 mx-md- mx-lg-5 containerDivInfoTienda'>
                            ...
                            <div className='modal fade' id='ReConfirmarModal'>
                                <div className='modal-dialog modal-dialog-centered' role='document'>
                                    <div className='modal-content Categoria-inputShadow Categoria-modal'>
                                        <div className='text-center modal-header border-bottom-0'>
                                            <h4 className='w-100 Categoria-Titulo modal-title' id='exampleModalLabel'>
                                        ...
                                        <div className='text-center modal-header border-bottom-0'>
                                            <h4
                                                ...
                                                id='exampleModalLabel'
                                            >
                                                ¿Está seguro que desea enviar mensaje al empleado para confirmar la
                                                reactivación?
                                            </h4>
                                        </div>
                                    ...
                                    <div className='modal-content Categoria-inputShadow Categoria-modal'>
                                        ...
                                        <div className='text-center modal-header border-bottom-0'>
                                            <h4
                                                ...
                                                id='exampleModalLabel'
                                            >
                                                ¿Está seguro que desea enviar mensaje al empleado para confirmar
                                                desactivación?
                                            </h4>
                                        </div>
